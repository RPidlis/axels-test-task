			...
			<Modal.Body>
				<Container className="p-2">
					<Row className="d-flex justify-content-around p-0 ">
						...
						<Col xs="10" sm="6" lg="3" className=" d-flex flex-column justify-content-around align-items-center mb-5 mt-2">
							<h3>Tickets</h3>
							<Col className="d-flex flex-column">
								{'//some choized tickets'}
							</Col>
							<Button variant="danger" onClick={() => onCloseModal()}>Buy Tickets</Button>
						</Col>
					</Row>
				</Container>
			</Modal.Body>
